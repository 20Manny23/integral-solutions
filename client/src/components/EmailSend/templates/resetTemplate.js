...
// export const reset_text_template = (tokenURL, firstName) => {
  export const reset_text_template = (props) => {
...
export const reset_html_template = (props) => {
  ...
  <p>
    <a style="background-color: #1a73e8; padding: 10px 20px; color: white; text-decoration:none;font-size:14px; font-family:Roboto,sans-serif;border-radius:5px" href=${props.tokenURL}
    >
      Click Here
    </a>
  </p>
