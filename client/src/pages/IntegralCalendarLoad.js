...
const IntegralCalendar = ({ activeView, weekendsVisible, INITIAL_EVENTS, renderEventContent, handleEventClick}) => {
  return (
    <div className="cal-app my-3 p-1 shadow border border-secondary rounded-lg">
      <div id="calendar" className="cal-app-main">
        {/* <FullCalendar
          ...
          buttonText={{
            today: "Today",import React from "react";
...
export default IntegralCalendar;
