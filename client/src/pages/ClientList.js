        ...
        <Row style={{display:'flex', justifyContent:'center'}}>
          {sorted.map((emp) => (
            <Card style={{ width: "18rem", margin: "5px" }}>
              <Card.Body>
                <Card.Title className="mb-2 text-muted">{emp.company}</Card.Title>
                <Card.Subtitle style={{marginTop:'3px'}}>Contact: {emp.contact} </Card.Subtitle>
                <Card.Subtitle style={{marginTop:'3px'}}>Phone: {emp.phone}</Card.Subtitle>
                <Card.Subtitle style={{marginTop:'3px'}}>{emp.email}</Card.Subtitle>
                <Card.Subtitle style={{marginTop:'3px'}}>{emp.location} </Card.Subtitle>
                <Card.Subtitle style={{marginTop:'3px'}}>{emp.city}, {emp.state} {emp.zip} </Card.Subtitle>
                <Card.Subtitle style={{marginTop:'3px'}}>Service Date: {emp.jobDate} </Card.Subtitle>
